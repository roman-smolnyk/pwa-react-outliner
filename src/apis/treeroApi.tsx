...
export const TreeRoAPI = {
  version: "0.0.1",
  TreeRoDataAPI: { YjsManager, Block, Page, Collection, Workspace },
  ...
  undo() {
    YjsManager.getYjs().undoManager?.undo();
  },

  redo() {
    YjsManager.getYjs().undoManager?.redo();
  },
};

declare global {
  interface Window {
    TreeRoAPI: typeof TreeRoAPI;
  }
}
