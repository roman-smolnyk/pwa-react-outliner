...
// import type { IDBLocalType, LocalConfigStateType, LocalIndexedDbDataType } from "./types";
...
//   async getLocalConfig(): Promise<LocalConfigStateType | undefined> {
//     const db = await getDB();
//     // Use the key you want; assuming only one config stored under 'current'
//     return db.get("localConfig", "current");
//   },

//   async setLocalConfig(localConfig: LocalConfigStateType) {
//     const db = await getDB();
