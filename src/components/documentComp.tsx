...
export default function DocumentComponent() {
  ...
  return (
    <div className="Document relative min-w-xs h-full z-1" ref={ref} data-id={currentDocumentId}>
      <div
        className="Document-scroll h-full overflow-y-auto overscroll-y-contain
